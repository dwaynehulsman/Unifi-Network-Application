...
wget -q -O docker-compose.yml https://raw.githubusercontent.com/dwaynehulsman/Unifi-Network-Application/main/OneLiner-home-assistant/docker-compose.yml >/dev/null 2>&1
